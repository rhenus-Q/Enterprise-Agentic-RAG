...
4. Apply this execution boundary: Review only. Write one architecture report under docs/roadmap/architecture-review and do not modify code, tests, configuration, or existing reports.
