---
name: apply-review-report
description: Apply justified, scoped fixes from a completed project-level architecture, security, failure-modes, test-coverage, or documentation-drift review report. Use when the user wants findings from docs/roadmap review artifacts implemented and validated within the approved scope.
---
...
4. Apply this execution boundary: Change only files required by accepted findings. Keep unrelated findings and unrelated working-tree changes untouched.
