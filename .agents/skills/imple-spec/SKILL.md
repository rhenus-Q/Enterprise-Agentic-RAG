---
name: imple-spec
description: Implement an already-approved specification or implementation plan for this Agentic RAG repository and produce the corresponding implementation report. Use when the user provides a spec or plan path and the decision to build has already been made.
---
...
4. Apply this execution boundary: Implement only the approved scope. Stop on material ambiguity or changes to routing, prompts, models, business behavior, or state schema that were not explicitly approved.
