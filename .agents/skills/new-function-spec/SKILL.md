---
name: new-function-spec
description: Create one implementation-ready function or focused-feature specification grounded in the current repository. Use when the user supplies a short feature description and wants a spec under docs/roadmap/spec without implementation.
---
...
4. Apply this execution boundary: Create exactly one new specification file. Do not implement the feature or modify code, tests, evals, configuration, or existing specifications.
