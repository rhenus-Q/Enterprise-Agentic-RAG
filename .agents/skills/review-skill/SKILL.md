---
name: review-skill
description: Review one repository Codex Skill for correct name and description metadata, trigger quality, workflow safety, input handling, output constraints, project fit, and permission assumptions. Use when the user names a Skill or SKILL.md path and wants a report under docs/roadmap/skills-review; do not edit the Skill.
---
...
4. Apply this execution boundary: Review only. Write one skill-review report and do not edit the target Skill, application files, tests, evals, AGENTS.md, or existing reports.
