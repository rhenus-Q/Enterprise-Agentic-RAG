...
const baseRuntimeStatus: RuntimeStatus = {
  ...
  requested_model_profile: "legacy",
  effective_model_profile: "legacy",
  model_profile_override_reason: null,
  model_profile_operational: true,
  model_targets: [
    {
      ...
      provider: "openai",
      model: "gpt-5-mini",
      request_settings: { temperature: 0, timeout_seconds: 60 },
    },
  ],
  embedding_provider: "openai",
  embedding_model: "text-embedding-ada-002",
...
export const runtimeFixtures = {
  ...
  local: {
    ...
    effective_model_profile: "local",
    model_profile_override_reason: "local_mode",
    model_targets: [
      {
        task: "question_router",
        tier: "local",
  ...
  configError: {
    provider: null,
    chat_model: null,
    requested_model_profile: null,
    effective_model_profile: null,
    model_profile_override_reason: null,
    model_profile_operational: null,
    model_targets: null,
