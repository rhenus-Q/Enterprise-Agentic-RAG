...
> Artifacts under `docs/roadmap/` — specs, plans, implementation reports, and all
> review reports — are local-only and gitignored by default; only `docs/roadmap/README.md`
> and the three workflow templates (spec / plan / implementation) are tracked
