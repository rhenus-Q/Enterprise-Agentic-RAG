...
| `tests/evals/` | The eval harness's pure helpers: dataset loading/validation, per-row checks, metrics, cost estimation, report rendering, and SHA/schema/count/mapping contracts for the final two formal benchmark artifacts | None — pure functions |
